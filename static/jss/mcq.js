 ...
 function badScore() {
     $('.panel-question').append('<h4>Sorry, this is not a passing score. Maybe read some more or something.</h4>');
 }
   ...
   panCount = (panCount+1) % $panels.length;
     ...
     switch (quesType) {
         ...
         case 'select-one':
          ...
          case 'annotate':
             $(curQues).find('.confirm').on('click', function () {
             var rightAns1 = "SUMMER";
             var rightAns2 = "WINTER";
             var rightAns3 = "FALL";
             var rightAns33 = "AUTUMN";
             var rightAns4 = "SPRING";
             var isCorrect1 = $('.fill-val-ann1').val().toUpperCase();
             var isCorrect2 = $('.fill-val-ann2').val().toUpperCase();
             var isCorrect3 = $('.fill-val-ann3').val().toUpperCase();
             var isCorrect4 = $('.fill-val-ann4').val().toUpperCase();
             if (isCorrect1 == rightAns1 && isCorrect2 == rightAns2 && isCorrect3 == rightAns3 || rightAns33 && isCorrect4 == rightAns4) {
             rightAnswer();
             } else if ((isCorrect1 == rightAns1) || (isCorrect2 == rightAns2) || (isCorrect3 == rightAns3) || (isCorrect4 == rightAns4)) {
             partialAnswer();
             } else {
             wrongAnswer();
             }
         ...
         case 'upload-image':
             ...
             case 'score':
               var message = 'You got ' + score + ' out of ' + ($panels.length - 1) + '.';
